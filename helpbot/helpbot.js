...
function sendMessage() {
    ...
    chatbotResponse.textContent = 'HelpBot: ' + response;
...
function getResponse(message) {
    ...
    else if (message.includes("work") || message.includes("working") || message.includes("works") || message.includes("project"))
    ...
    else if (message.includes("hospital near me") || message.includes("hospital near me") || message.includes("nearby hospital"))
        return "Locating the nearest hospital is easy with our hospital finder tool. Simply enter your location to find hospitals in your area along with directions and contact information.";
    else if (message.includes("medimatch"))
        return "MediMatch is a tool with a database of 400+ diseases that analyzes your symptoms and illness to provide personalized treatment and remedies recommendations.";
